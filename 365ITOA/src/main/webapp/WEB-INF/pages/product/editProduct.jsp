...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form action="${pageContext.request.contextPath}/product/editProduct.action" method="post" role="form">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="form-group">
                                        <label>上线时间</label>
                                        <input class="form-control" type="text" name="onlineTime" value="${product.onlineTime}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="form-group">
                                        <label>下线时间</label>
                                        <input class="form-control" type="text" name="offlineTime" value="${product.offlineTime}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="form-group">
                                        <label>网盘地址</label>
                                        <input class="form-control" type="text" name="cloudeUrl" value="${product.cloudeUrl}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="form-group">
                                        <label>网盘提取码</label>
                                        <input class="form-control" type="text" name="cloudeCode" value="${product.cloudeCode}">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" >
                                            <c:forEach items="${productStatusDicList}" var="productStatusDic">
                                                <c:if test="${productStatusDic.dicCode.equals(product.status)}">
                                                    <option value="${productStatusDic.dicCode}" selected="selected">${productStatusDic.dicCn}</option>
                                                </c:if>
                                                <c:if test="${!productStatusDic.dicCode.equals(product.status)}">
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="form-group">
                                        <label>课程更新时间</label>
                                        <input class="form-control" type="text" name="updateDate" value="${product.updateDate}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="intro" class="form-control" rows="3" name="productIntroduction">${product.productIntroduction}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="desc" class="form-control" rows="3" name="productDesc">${product.productDesc}</textarea>
                                    </div>
                                </div>
